package com.smartstore.api.v1.gateway.admin.categorynode;
...
import com.smartstore.api.v1.gateway.admin.categorynode.facade.AdminCategoryNodeFacade;
...
class Config {
  protected static final String BASE_URL = "/api/v1/admin/categories/node";
...
public class AdminCategoryNodeController {
  ...
  private final AdminCategoryNodeFacade adminCategoryNodeFacade;

  public AdminCategoryNodeController(AdminCategoryNodeFacade adminCategoryNodeFacade) {
