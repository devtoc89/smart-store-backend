...
final class Config {
  protected static final String BASE_URL = BaseURLConstants.BASE_URL + "/products";
...
public class AdminProductController {
  ...
  private final AdminProductAppService adminProductFacade;

  public AdminProductController(AdminProductAppService adminProductFacade) {
